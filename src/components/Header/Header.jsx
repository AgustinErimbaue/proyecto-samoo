            ...
            <Box className='header-container' sx={{
                ...
                <Flex as='header' width='100%' alignItems='center' justifyContent='space-between'>
                    <Box className='logo-container' sx={{
                        ...
                        <Image src="src/assets/Img/logo-empresa.png" alt="logo" className='logo-company' sx={{
                            width: '150px',
                            height: 'auto',
                        }} />
                    </Box>
                    <Box className='btn-header' sx={{
                        display: 'flex',
                        gap: '15px',
                        justifyContent: 'center',
                        flex: '1',
                    }}>
                        {['CALENDARIO', 'EVENTOS', 'PARTICIPANTES', 'FEEDBACK', 'DASHBOARD'].map((buttonName) => (
                            <Button
                                key={buttonName}
                                colorScheme='black'
                                variant='ghost'
